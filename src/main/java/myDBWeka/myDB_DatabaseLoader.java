 ...
 * @see Loader
 */
public class myDB_DatabaseLoader extends AbstractLoader implements BatchConverter,
   ...
   */
  public myDB_DatabaseLoader() throws Exception {
...
*/
  ...
  public static void main(String[] options) {
    ...
    myDB_DatabaseLoader atf;
    try {
      atf = new myDB_DatabaseLoader();
