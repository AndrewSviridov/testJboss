 ...
 */
public class myDB_InstanceQuery extends myDB_DatabaseUtils implements OptionHandler,
   ...
   */
  public myDB_InstanceQuery() throws Exception {
...
*/
  ...
  public static void main(String[] args) {
    ...
    try {
      myDB_InstanceQuery iq = new myDB_InstanceQuery();
